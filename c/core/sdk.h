// Obsidian SDK — umbrella runtime header (template; Obsidian tokens
...
#ifndef OBSIDIAN_SDK_H
#define OBSIDIAN_SDK_H
...
typedef struct ObsidianSDK ObsidianSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs ObsidianError)
// ===========================================================================
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + ObsidianEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (ObsidianEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment ObsidianSDK) — generic fields.
// ===========================================================================
...
void sdk_features_push(ObsidianSDK* sdk, Feature* f);
void sdk_features_insert(ObsidianSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(ObsidianSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(ObsidianSDK* sdk); // deep clone of options
Utility* sdk_get_utility(ObsidianSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(ObsidianSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
ObsidianSDK* obsidian_sdk_new(voxgig_value* options);
ObsidianSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(ObsidianSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(ObsidianSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_graphql(ObsidianSDK* sdk, const char* query,
