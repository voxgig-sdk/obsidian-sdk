// Behavioural feature-test harness for the Obsidian SDK (C port of the
...
#ifndef OBSIDIAN_FEATURE_HARNESS_H
#define OBSIDIAN_FEATURE_HARNESS_H
...
#endif // OBSIDIAN_FEATURE_HARNESS_H
