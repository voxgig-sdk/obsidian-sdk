// Generated direct-call test for the entity1 entity (mirrors the
...
static voxgig_value* entity1_mock(void* ud, voxgig_value* args) {
  CALLS++;
...
static ObsidianSDK* entity1_direct_setup(voxgig_value* mockres) {
  voxgig_value* opts = cmap(2,
    "base", v_str("http://localhost:8080"),
    "system", cmap(1, "fetch", vfn(entity1_mock, mockres)));
...
int main(void) {
  ...
  // LOAD
  {
    ...
    ObsidianSDK* sdk = entity1_direct_setup(mockres);
  ...
  TEST_SUMMARY("obsidian_entity1_direct");
}
