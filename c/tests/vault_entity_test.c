// Generated instance test for the vault entity.
...
int main(void) {
  ...
  Entity* e = obsidian_vault(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "vault", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = obsidian_vault(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = vault_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = obsidian_vault(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = vault_stream(pe, "list", NULL, NULL, &perr);
