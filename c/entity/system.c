// System entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*system_postdone_fn)(system_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT system_VT;
static const char* system_get_name(Entity* e);
static Entity* system_make(Entity* e);
static voxgig_value* system_data(Entity* e, voxgig_value* args);
static voxgig_value* system_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* system_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** system_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* system_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* system_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* system_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void system_mark_deleted(Entity* e);
static bool system_deleted(Entity* e);

static Context* system_ent_ctx(system_entity* self) {
  return self->entctx;
}
...
Entity* system_entity_new(ObsidianSDK* client, voxgig_value* entopts) {
  ...
  system_entity* self = (system_entity*)calloc(1, sizeof(system_entity));
  self->base.vt = &system_VT;
  self->name = strdup("system");
  self->client = client;
...
static voxgig_value* system_run_op(system_entity* self, Context* ctx,
                                    system_postdone_fn post_done, PNError** err) {
...
voxgig_value* system_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  system_entity* self = (system_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, system_ent_ctx(self));
...
static Entity* system_make(Entity* e) {
  ...
  return system_entity_new(self->client, opts);
}
...
static voxgig_value* system_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(system_ent_ctx(self), "SetData");
  }
  feature_hook_util(system_ent_ctx(self), "GetData");
...
static voxgig_value* system_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(system_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(system_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void system_load_postdone(system_entity* self, Context* ctx) {
...
static Entity* system_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, system_ent_ctx(self));
  system_run_op(self, ctx, system_load_postdone, err);
  if (*err) return NULL;
...
static Entity** system_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "system");
  return NULL;
}

static Entity* system_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "system");
  return NULL;
}

static Entity* system_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "system");
  return NULL;
}

static Entity* system_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "system");
  return NULL;
}
...
// live record.
static void system_mark_deleted(Entity* e) {
  ((system_entity*)e)->deleted = true;
}

static bool system_deleted(Entity* e) {
  return ((system_entity*)e)->deleted;
}
