// Mcp entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*mcp_postdone_fn)(mcp_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT mcp_VT;
static const char* mcp_get_name(Entity* e);
static Entity* mcp_make(Entity* e);
static voxgig_value* mcp_data(Entity* e, voxgig_value* args);
static voxgig_value* mcp_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* mcp_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** mcp_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* mcp_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* mcp_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* mcp_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void mcp_mark_deleted(Entity* e);
static bool mcp_deleted(Entity* e);

static Context* mcp_ent_ctx(mcp_entity* self) {
  return self->entctx;
}
...
Entity* mcp_entity_new(ObsidianSDK* client, voxgig_value* entopts) {
  ...
  mcp_entity* self = (mcp_entity*)calloc(1, sizeof(mcp_entity));
  self->base.vt = &mcp_VT;
  self->name = strdup("mcp");
  self->client = client;
...
static voxgig_value* mcp_run_op(mcp_entity* self, Context* ctx,
                                    mcp_postdone_fn post_done, PNError** err) {
...
voxgig_value* mcp_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  mcp_entity* self = (mcp_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, mcp_ent_ctx(self));
...
static Entity* mcp_make(Entity* e) {
  ...
  return mcp_entity_new(self->client, opts);
}
...
static voxgig_value* mcp_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(mcp_ent_ctx(self), "SetData");
  }
  feature_hook_util(mcp_ent_ctx(self), "GetData");
...
static voxgig_value* mcp_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(mcp_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(mcp_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void mcp_load_postdone(mcp_entity* self, Context* ctx) {
...
static Entity* mcp_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, mcp_ent_ctx(self));
  mcp_run_op(self, ctx, mcp_load_postdone, err);
  if (*err) return NULL;
...
static Entity** mcp_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "mcp");
  return NULL;
}


static void mcp_create_postdone(mcp_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static Entity* mcp_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, mcp_ent_ctx(self));
  mcp_run_op(self, ctx, mcp_create_postdone, err);
  if (*err) return NULL;
...
static Entity* mcp_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "mcp");
  return NULL;
}

static Entity* mcp_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "mcp");
  return NULL;
}
...
// live record.
static void mcp_mark_deleted(Entity* e) {
  ((mcp_entity*)e)->deleted = true;
}

static bool mcp_deleted(Entity* e) {
  return ((mcp_entity*)e)->deleted;
}
