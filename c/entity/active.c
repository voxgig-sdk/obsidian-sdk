// Active entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*active_postdone_fn)(active_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT active_VT;
static const char* active_get_name(Entity* e);
static Entity* active_make(Entity* e);
static voxgig_value* active_data(Entity* e, voxgig_value* args);
static voxgig_value* active_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* active_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** active_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* active_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* active_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* active_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void active_mark_deleted(Entity* e);
static bool active_deleted(Entity* e);

static Context* active_ent_ctx(active_entity* self) {
  return self->entctx;
}
...
Entity* active_entity_new(ObsidianSDK* client, voxgig_value* entopts) {
  ...
  active_entity* self = (active_entity*)calloc(1, sizeof(active_entity));
  self->base.vt = &active_VT;
  self->name = strdup("active");
  self->client = client;
...
static voxgig_value* active_run_op(active_entity* self, Context* ctx,
                                    active_postdone_fn post_done, PNError** err) {
...
voxgig_value* active_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  active_entity* self = (active_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, active_ent_ctx(self));
...
static Entity* active_make(Entity* e) {
  ...
  return active_entity_new(self->client, opts);
}
...
static voxgig_value* active_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(active_ent_ctx(self), "SetData");
  }
  feature_hook_util(active_ent_ctx(self), "GetData");
...
static voxgig_value* active_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(active_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(active_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void active_load_postdone(active_entity* self, Context* ctx) {
...
static Entity* active_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, active_ent_ctx(self));
  active_run_op(self, ctx, active_load_postdone, err);
  if (*err) return NULL;
...
static Entity** active_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "active");
  return NULL;
}


static void active_create_postdone(active_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static Entity* active_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, active_ent_ctx(self));
  active_run_op(self, ctx, active_create_postdone, err);
  if (*err) return NULL;
...
static void active_update_postdone(active_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* active_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, active_ent_ctx(self));
  active_run_op(self, ctx, active_update_postdone, err);
  if (*err) return NULL;
...
static void active_remove_postdone(active_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* active_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, active_ent_ctx(self));
  active_run_op(self, ctx, active_remove_postdone, err);
  if (*err) return NULL;
...
// live record.
static void active_mark_deleted(Entity* e) {
  ((active_entity*)e)->deleted = true;
}

static bool active_deleted(Entity* e) {
  return ((active_entity*)e)->deleted;
}
