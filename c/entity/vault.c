// Vault entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*vault_postdone_fn)(vault_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT vault_VT;
static const char* vault_get_name(Entity* e);
static Entity* vault_make(Entity* e);
static voxgig_value* vault_data(Entity* e, voxgig_value* args);
static voxgig_value* vault_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* vault_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** vault_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* vault_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* vault_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* vault_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void vault_mark_deleted(Entity* e);
static bool vault_deleted(Entity* e);

static Context* vault_ent_ctx(vault_entity* self) {
  return self->entctx;
}
...
Entity* vault_entity_new(ObsidianSDK* client, voxgig_value* entopts) {
  ...
  vault_entity* self = (vault_entity*)calloc(1, sizeof(vault_entity));
  self->base.vt = &vault_VT;
  self->name = strdup("vault");
  self->client = client;
...
static voxgig_value* vault_run_op(vault_entity* self, Context* ctx,
                                    vault_postdone_fn post_done, PNError** err) {
...
voxgig_value* vault_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  vault_entity* self = (vault_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, vault_ent_ctx(self));
...
static Entity* vault_make(Entity* e) {
  ...
  return vault_entity_new(self->client, opts);
}
...
static voxgig_value* vault_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(vault_ent_ctx(self), "SetData");
  }
  feature_hook_util(vault_ent_ctx(self), "GetData");
...
static voxgig_value* vault_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(vault_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(vault_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void vault_load_postdone(vault_entity* self, Context* ctx) {
...
static Entity* vault_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, vault_ent_ctx(self));
  vault_run_op(self, ctx, vault_load_postdone, err);
  if (*err) return NULL;
...
static void vault_list_postdone(vault_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static Entity** vault_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, vault_ent_ctx(self));
  voxgig_value* out = vault_run_op(self, ctx, vault_list_postdone, err);
  if (*err) return NULL;
...
static void vault_create_postdone(vault_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static Entity* vault_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, vault_ent_ctx(self));
  vault_run_op(self, ctx, vault_create_postdone, err);
  if (*err) return NULL;
...
static void vault_update_postdone(vault_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* vault_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, vault_ent_ctx(self));
  vault_run_op(self, ctx, vault_update_postdone, err);
  if (*err) return NULL;
...
static void vault_remove_postdone(vault_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* vault_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, vault_ent_ctx(self));
  vault_run_op(self, ctx, vault_remove_postdone, err);
  if (*err) return NULL;
...
// live record.
static void vault_mark_deleted(Entity* e) {
  ((vault_entity*)e)->deleted = true;
}

static bool vault_deleted(Entity* e) {
  return ((vault_entity*)e)->deleted;
}
