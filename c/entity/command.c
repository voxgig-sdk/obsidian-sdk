// Command entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*command_postdone_fn)(command_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT command_VT;
static const char* command_get_name(Entity* e);
static Entity* command_make(Entity* e);
static voxgig_value* command_data(Entity* e, voxgig_value* args);
static voxgig_value* command_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* command_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** command_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* command_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* command_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* command_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void command_mark_deleted(Entity* e);
static bool command_deleted(Entity* e);

static Context* command_ent_ctx(command_entity* self) {
  return self->entctx;
}
...
Entity* command_entity_new(ObsidianSDK* client, voxgig_value* entopts) {
  ...
  command_entity* self = (command_entity*)calloc(1, sizeof(command_entity));
  self->base.vt = &command_VT;
  self->name = strdup("command");
  self->client = client;
...
static voxgig_value* command_run_op(command_entity* self, Context* ctx,
                                    command_postdone_fn post_done, PNError** err) {
...
voxgig_value* command_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  command_entity* self = (command_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, command_ent_ctx(self));
...
static Entity* command_make(Entity* e) {
  ...
  return command_entity_new(self->client, opts);
}
...
static voxgig_value* command_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(command_ent_ctx(self), "SetData");
  }
  feature_hook_util(command_ent_ctx(self), "GetData");
...
static voxgig_value* command_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(command_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(command_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* command_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "command");
  return NULL;
}


static void command_list_postdone(command_entity* self, Context* ctx) {
...
static Entity** command_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, command_ent_ctx(self));
  voxgig_value* out = command_run_op(self, ctx, command_list_postdone, err);
  if (*err) return NULL;
...
static void command_create_postdone(command_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
...
static Entity* command_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, command_ent_ctx(self));
  command_run_op(self, ctx, command_create_postdone, err);
  if (*err) return NULL;
...
static Entity* command_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "command");
  return NULL;
}

static Entity* command_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "command");
  return NULL;
}
...
// live record.
static void command_mark_deleted(Entity* e) {
  ((command_entity*)e)->deleted = true;
}

static bool command_deleted(Entity* e) {
  return ((command_entity*)e)->deleted;
}
