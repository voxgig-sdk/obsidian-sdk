...
local VaultEntity = {}
VaultEntity.__index = VaultEntity


function VaultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VaultEntity)
  self._name = "vault"
  self._client = client
...
function VaultEntity:get_name()
  return self._name
end


function VaultEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VaultEntity.new(self._client, opts)
end
...
function VaultEntity:mark_deleted()
  self._deleted = true
end


function VaultEntity:deleted()
  return true == self._deleted
end


function VaultEntity:data_set(args)
  if args ~= nil then
...
function VaultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VaultEntity:match_set(args)
  if args ~= nil then
...
function VaultEntity:match_get()
...
function VaultEntity:stream(action, args, callopts)
...
---@param reqmatch VaultLoadMatch
---@param ctrl? table
---@return Vault
---@return string? err
function VaultEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch VaultListMatch
---@param ctrl? table
---@return Vault[]
---@return string? err
function VaultEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata VaultCreateData
---@param ctrl? table
---@return Vault
---@return string? err
function VaultEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata VaultUpdateData
---@param ctrl? table
---@return Vault
---@return string? err
function VaultEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch VaultRemoveMatch
---@param ctrl? table
---@return Vault
---@return string? err
function VaultEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function VaultEntity:_run_op(ctx, post_done)
  local utility = self._utility
