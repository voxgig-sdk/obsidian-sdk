...
function ActiveEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActiveEntity)
  self._name = "active"
  self._client = client
...
function ActiveEntity:get_name()
  return self._name
end


function ActiveEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActiveEntity.new(self._client, opts)
end
...
function ActiveEntity:mark_deleted()
  self._deleted = true
end


function ActiveEntity:deleted()
  return true == self._deleted
end


function ActiveEntity:data_set(args)
  if args ~= nil then
...
function ActiveEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActiveEntity:match_set(args)
  if args ~= nil then
...
function ActiveEntity:match_get()
...
function ActiveEntity:stream(action, args, callopts)
...
---@param reqmatch ActiveLoadMatch
---@param ctrl? table
---@return Active
---@return string? err
function ActiveEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ActiveCreateData
---@param ctrl? table
---@return Active
---@return string? err
function ActiveEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ActiveUpdateData
---@param ctrl? table
---@return Active
---@return string? err
function ActiveEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ActiveRemoveMatch
---@param ctrl? table
---@return Active
---@return string? err
function ActiveEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ActiveEntity:_run_op(ctx, post_done)
  local utility = self._utility
