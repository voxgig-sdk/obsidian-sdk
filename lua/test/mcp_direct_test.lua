...
describe("McpDirect", function()
  it("should direct-load-mcp", function()
    local setup = mcp_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-mcp", setup.live and "live" or "unit")
