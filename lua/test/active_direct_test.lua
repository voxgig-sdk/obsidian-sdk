...
describe("ActiveDirect", function()
  it("should direct-load-active", function()
    local setup = active_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-active", setup.live and "live" or "unit")
...
function active_direct_setup(mockres)
