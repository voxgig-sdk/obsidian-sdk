...
(0, node_test_1.describe)('OpenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'open.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != open_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/open/OpenTestData.json');
    ...
    let idmap = transform(['open01', 'open02', 'open03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OpenEntity.test.js.map