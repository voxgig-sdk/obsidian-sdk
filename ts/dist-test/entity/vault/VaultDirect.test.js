...
(0, node_test_1.describe)('VaultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-vault', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-vault', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-vault', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-vault', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.OBSIDIAN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    const client = new __1.ObsidianSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=VaultDirect.test.js.map