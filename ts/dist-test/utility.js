...
function envOverride(m) {
    if ('TRUE' === process.env.OBSIDIAN_TEST_LIVE ||
        'TRUE' === process.env.OBSIDIAN_TEST_OVERRIDE) {
    ...
    m.OBSIDIAN_TEST_EXPLAIN = process.env.OBSIDIAN_TEST_EXPLAIN || m.OBSIDIAN_TEST_EXPLAIN;
    return m;
}
