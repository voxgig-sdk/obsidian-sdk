...
const ObsidianEntityBase_1 = require("./ObsidianEntityBase");
Object.defineProperty(exports, "ObsidianEntityBase", { enumerable: true, get: function () { return ObsidianEntityBase_1.ObsidianEntityBase; } });
...
class ObsidianSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('ObsidianSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('ObsidianSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('ObsidianSDK: graphql: ' +
    ...
    // Entity access: `client.Vault().list()` / `client.Vault().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    Vault(entopts) {
        const self = this;
        return new VaultEntity_1.VaultEntity(self, entopts);
    }
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new ObsidianSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    tester(testopts, sdkopts) {
        return ObsidianSDK.test(testopts, sdkopts);
    }
    toJSON() {
        return { name: 'Obsidian' };
    }
    toString() {
        return 'Obsidian ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.ObsidianSDK = ObsidianSDK;
const SDK = ObsidianSDK;
exports.SDK = SDK;
//# sourceMappingURL=ObsidianSDK.js.map