...
class ActiveEntity extends ObsidianEntityBase<Active> {
  ...
  async load(this: any, reqmatch?: ActiveLoadMatch, ctrl?: Control): Promise<ActiveEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Active> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: ActiveCreateData, ctrl?: Control): Promise<ActiveEntity> {
  ...
  async update(this: any, reqdata?: ActiveUpdateData, ctrl?: Control): Promise<ActiveEntity> {
  ...
  async remove(
    this: any, reqmatch?: ActiveRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ActiveEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
