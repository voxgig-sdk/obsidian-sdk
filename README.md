...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/obsidian` | publish pending — [install from git tag](https://github.com/voxgig-sdk/obsidian-sdk/releases) |
| Python | `voxgig-sdk-obsidian` | publish pending — [install from git tag](https://github.com/voxgig-sdk/obsidian-sdk/releases) |
| PHP | `voxgig-sdk/obsidian` | publish pending — [install from git tag](https://github.com/voxgig-sdk/obsidian-sdk/releases) |
| Golang | `github.com/voxgig-sdk/obsidian-sdk/go` | `go get github.com/voxgig-sdk/obsidian-sdk/go@latest` |
| Ruby | `voxgig-sdk-obsidian` | publish pending — [install from git tag](https://github.com/voxgig-sdk/obsidian-sdk/releases) |
| Lua | `voxgig-sdk-obsidian` | publish pending — [install from git tag](https://github.com/voxgig-sdk/obsidian-sdk/releases) |
