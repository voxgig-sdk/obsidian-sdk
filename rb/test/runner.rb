...
module ObsidianTestRunner
  ...
  def self.env_override(m)
    live = getenv("OBSIDIAN_TEST_LIVE")
    override = getenv("OBSIDIAN_TEST_OVERRIDE")
    ...
    explain = getenv("OBSIDIAN_TEST_EXPLAIN")
    m["OBSIDIAN_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ObsidianTestRunner
Helpers = ObsidianHelpers
Vs = VoxgigStruct
