...
class ActiveEntity
  ...
  # @return [Active, Hash] the current Active data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Active fields)
  def match_get
  ...
  #
  # @param reqmatch [ActiveLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Active.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Active, Hash] the loaded Active; raises ObsidianError on failure
  ...
  # Create a new Active.
  #
  # @param reqdata [ActiveCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Active, Hash] the created Active; raises ObsidianError on failure
  ...
  #
  # @param reqdata [ActiveUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Active, Hash] the updated Active; raises ObsidianError on failure
  ...
  #
  # @param reqmatch [ActiveRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Active, Hash] the removed Active; raises ObsidianError on failure
