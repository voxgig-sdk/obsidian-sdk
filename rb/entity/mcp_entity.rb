...
class McpEntity
  ...
  # Load a single Mcp.
  #
  # @param reqmatch [McpLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Mcp.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Mcp, Hash] the loaded Mcp; raises ObsidianError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Mcp, Hash] the created Mcp; raises ObsidianError on failure
