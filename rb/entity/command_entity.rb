...
class CommandEntity
  ...
  def make
    opts = @_entopts.dup
    CommandEntity.new(@_client, opts)
  end
  ...
  # @return [Command, Hash] the current Command data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Command fields)
  def match_get
  ...
  #
  # @param reqmatch [CommandListMatch, Hash, nil] match filter (any subset of
  #   Command fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Command>, Array] the matching Command items; raises ObsidianError on failure
  ...
  #
  # @param reqdata [CommandCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Command, Hash] the created Command; raises ObsidianError on failure
