...
class OpenEntity
  ...
  # @return [Open, Hash] the current Open data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Open fields)
  def match_get
  ...
  # Create a new Open.
  #
  # @param reqdata [OpenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Open, Hash] the created Open; raises ObsidianError on failure
