...
func registerSDKWords(r *eng.Registry, client *sdk.ObsidianSDK) {
...
func runOp(client *sdk.ObsidianSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
