...
class ObsidianPagingFeature extends ObsidianBaseFeature
{
    ...
    private function _graphql_pre_request(ObsidianContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(ObsidianContext $ctx): bool
    {
