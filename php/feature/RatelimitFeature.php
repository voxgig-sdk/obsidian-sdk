...
// Obsidian SDK ratelimit feature
...
class ObsidianRatelimitFeature extends ObsidianBaseFeature
{
    ...
    private function _acquire(ObsidianContext $ctx): void
    {
    ...
    private function _track(ObsidianContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
