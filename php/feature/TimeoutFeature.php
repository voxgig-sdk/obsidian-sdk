...
class ObsidianTimeoutFeature extends ObsidianBaseFeature
{
    ...
    private function _with_timeout(ObsidianContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ObsidianContext $_ctx, float $ms): void
    {
        $client = $this->client;
