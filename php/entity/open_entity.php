...
class OpenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OpenEntity($this->_client, $opts);
    }

    /**
     * @param Open|array $args Open data (assoc-array) to store.
     */
    ...
    /**
     * @return Open|array The current Open data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Open fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Open fields).
     */
     ...
     * Create a new Open.
     *
     * @param OpenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OpenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Open|array The created Open as an assoc-array at the
