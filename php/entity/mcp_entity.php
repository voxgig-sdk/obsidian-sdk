...
class McpEntity
{
     ...
     * Load a single Mcp.
     *
     * @param McpLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed McpLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mcp|array The loaded Mcp as an assoc-array at the
