...
class CommandEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CommandEntity($this->_client, $opts);
    }

    /**
     * @param Command|array $args Command data (assoc-array) to store.
     */
    ...
    /**
     * @return Command|array The current Command data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Command fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Command fields).
     */
    ...
    /**
     * List Command items matching the given filter.
     *
     * @param CommandListMatch|array|null $reqmatch Match filter (any subset
     *   of Command fields) as an assoc-array; CommandListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Command[]|array A list of Command items as assoc-arrays at
     ...
     *
     * @param CommandCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CommandCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Command|array The created Command as an assoc-array at the
