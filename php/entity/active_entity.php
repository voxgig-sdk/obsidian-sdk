...
class ActiveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActiveEntity($this->_client, $opts);
    }

    /**
     * @param Active|array $args Active data (assoc-array) to store.
     */
    ...
    /**
     * @return Active|array The current Active data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Active fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Active fields).
     */
    ...
    /**
     * Load a single Active.
     *
     * @param ActiveLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActiveLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Active|array The loaded Active as an assoc-array at the
     ...
     * Create a new Active.
     *
     * @param ActiveCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActiveCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Active|array The created Active as an assoc-array at the
     *   SDK boundary; throws ObsidianError on failure (item-5 convention).
     */
     ...
     *
     * @param ActiveUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActiveUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Active|array The updated Active as an assoc-array at the
     *   SDK boundary; throws ObsidianError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Active matching the given criteria.
     *
     * @param ActiveRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ActiveRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Active|array The removed Active as an assoc-array at the
     *   SDK boundary; throws ObsidianError on failure (item-5 convention).
     */
