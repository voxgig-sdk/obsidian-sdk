...
class ObsidianFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ObsidianSDK/1.0)';
    ...
    public static function call(ObsidianContext $ctx, string $fullurl, array $fetchdef): array
    {
