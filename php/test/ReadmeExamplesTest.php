...
// Obsidian SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ObsidianSDK::test)
...
{
    private const SDK_CLASS = 'ObsidianSDK';
    ...
    private const SDK_BASE = 'obsidian_sdk';
