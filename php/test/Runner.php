...
class ObsidianTestRunner
{
    ...
    {
        $live = self::getenv('OBSIDIAN_TEST_LIVE');
        $override = self::getenv('OBSIDIAN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OBSIDIAN_TEST_EXPLAIN');
...
class_alias('ObsidianTestRunner', 'Runner');
class_alias('ObsidianHelpers', 'Helpers');
