...
// Obsidian SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ObsidianOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ObsidianOmni::structfix($now, Struct::undef()))
                        !== json_encode(ObsidianOmni::structfix($val, Struct::undef()))) {
