...
class ActiveDirectTest extends TestCase
{
    public function test_direct_load_active(): void
    {
        $setup = active_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-active", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
