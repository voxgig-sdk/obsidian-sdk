...
class CommandDirectTest extends TestCase
{
    public function test_direct_list_command(): void
    {
        $setup = command_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-command", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
