# Obsidian SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ObsidianSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ObsidianSDK(...) and ObsidianSDK.test(...) become
#      ObsidianSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "obsidian_sdk"
_SDK_CLASS = "ObsidianSDK"
