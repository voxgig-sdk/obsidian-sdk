...
class TestMcpDirect:
    ...
    def test_should_direct_load_mcp(self):
        setup = _mcp_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-mcp", "live" if setup["live"] else "unit")
        if _skip:
