...
from obsidian_sdk.core.control import ObsidianControl
...
from obsidian_sdk.core.helpers import get_ctx_prop, to_map
...
class ObsidianContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, ObsidianResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ObsidianResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ObsidianError(code, msg, self)
