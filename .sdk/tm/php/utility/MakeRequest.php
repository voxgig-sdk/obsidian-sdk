...
// Obsidian SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ObsidianMakeRequest
{
    public static function call(ObsidianContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ObsidianResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ObsidianResponse($fetched);
        } else {
