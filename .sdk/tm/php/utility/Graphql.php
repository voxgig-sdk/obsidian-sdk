...
class ObsidianGraphql
{
    ...
    // equivalent.
    public static function body(ObsidianContext $ctx): mixed
    {
    ...
    public static function errors(ObsidianContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
