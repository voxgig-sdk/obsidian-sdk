...
// Obsidian SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ObsidianTestFeature extends ObsidianBaseFeature
{
    ...
    public function init(ObsidianContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ObsidianContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ObsidianContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ObsidianContext $ctx, $op, $args): array
    {
