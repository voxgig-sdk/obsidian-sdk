...
from projectname_sdk import ObsidianSDK
from projectname_sdk.core.spec import ObsidianSpec
from projectname_sdk.core.result import ObsidianResult
from projectname_sdk.core.operation import ObsidianOperation
from projectname_sdk.core.error import ObsidianError
from projectname_sdk.feature.base_feature import ObsidianBaseFeature
...
_runner = makeRunner(TEST_JSON_FILE, ObsidianSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ObsidianSDK.test(None, None)
        utility = client._utility
    ...
    def test_feature_init_basic(self):
        init_client = ObsidianSDK.test(None, None)
        ...
        class TestInitFeature(ObsidianBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ObsidianBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ObsidianSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ObsidianSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ObsidianSDK.test(None, setup.get('a') or {})
