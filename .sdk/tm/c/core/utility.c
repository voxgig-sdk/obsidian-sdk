...
// ---- SDK client-base generic helpers (Main.fragment ObsidianSDK) -------
...
voxgig_value* sdk_options_map(ObsidianSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(ObsidianSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(ObsidianSDK* sdk) { return sdk->rootctx; }
