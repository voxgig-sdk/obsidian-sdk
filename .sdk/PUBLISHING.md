...
|---|---|---|
| `ts/` | @voxgig-sdk/obsidian | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/obsidian \
      --repository voxgig-sdk/obsidian-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/obsidian` shows it, and
`npm trust revoke @voxgig-sdk/obsidian --id=<id>` removes it.
