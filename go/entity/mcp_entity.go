...
func NewMcpEntity(client *core.ObsidianSDK, entopts map[string]any) *McpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *McpEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// McpLoadMatch and returns an Mcp. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *McpEntity) LoadTyped(reqmatch McpLoadMatch, ctrl map[string]any) (Mcp, error) {
