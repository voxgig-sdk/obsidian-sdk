...
func NewActiveEntity(client *core.ObsidianSDK, entopts map[string]any) *ActiveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActiveEntity) GetName() string { return e.name }
...
func (e *ActiveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ActiveEntity) Deleted() bool {
	return e.deleted
}


func (e *ActiveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewActiveEntity(e.client, opts)
}

func (e *ActiveEntity) Data(args ...any) any {
...
func (e *ActiveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Active; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ActiveEntity) DataTyped(data ...Active) Active {
	if len(data) > 0 {
		return typedFrom[Active](e.Data(asMap(data[0])))
	}
	return typedFrom[Active](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Active (all fields
// optional at the wire level).
func (e *ActiveEntity) MatchTyped(match ...Active) Active {
	if len(match) > 0 {
		return typedFrom[Active](e.Match(asMap(match[0])))
	}
	return typedFrom[Active](e.Match())
}
...
func (e *ActiveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ActiveEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActiveLoadMatch and returns an Active. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ActiveEntity) LoadTyped(reqmatch ActiveLoadMatch, ctrl map[string]any) (Active, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Active{}, err
	}
	return typedFrom[Active](res), nil
}



func (e *ActiveEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ActiveEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ActiveCreateData and returns an Active. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ActiveEntity) CreateTyped(reqdata ActiveCreateData, ctrl map[string]any) (Active, error) {
...
func (e *ActiveEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ActiveUpdateData and returns an Active. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ActiveEntity) UpdateTyped(reqdata ActiveUpdateData, ctrl map[string]any) (Active, error) {
...
func (e *ActiveEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ActiveRemoveMatch and returns an Active. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ActiveEntity) RemoveTyped(reqmatch ActiveRemoveMatch, ctrl map[string]any) (Active, error) {
...
func (e *ActiveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
