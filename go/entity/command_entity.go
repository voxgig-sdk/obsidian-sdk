...
func NewCommandEntity(client *core.ObsidianSDK, entopts map[string]any) *CommandEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommandEntity) GetName() string { return e.name }
...
func (e *CommandEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CommandEntity) Deleted() bool {
	return e.deleted
}


func (e *CommandEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCommandEntity(e.client, opts)
}

func (e *CommandEntity) Data(args ...any) any {
...
func (e *CommandEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Command; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CommandEntity) DataTyped(data ...Command) Command {
	if len(data) > 0 {
		return typedFrom[Command](e.Data(asMap(data[0])))
	}
	return typedFrom[Command](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Command (all fields
// optional at the wire level).
func (e *CommandEntity) MatchTyped(match ...Command) Command {
	if len(match) > 0 {
		return typedFrom[Command](e.Match(asMap(match[0])))
	}
	return typedFrom[Command](e.Match())
}
...
func (e *CommandEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CommandEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CommandEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CommandListMatch and returns []Command. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CommandEntity) ListTyped(reqmatch CommandListMatch, ctrl map[string]any) ([]Command, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Command](res), nil
}




func (e *CommandEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CommandCreateData and returns an Command. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CommandEntity) CreateTyped(reqdata CommandCreateData, ctrl map[string]any) (Command, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Command{}, err
	}
	return typedFrom[Command](res), nil
}



func (e *CommandEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CommandEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CommandEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
