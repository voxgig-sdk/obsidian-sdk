...
func NewVaultEntity(client *core.ObsidianSDK, entopts map[string]any) *VaultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VaultEntity) GetName() string { return e.name }
...
func (e *VaultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VaultEntity) Deleted() bool {
	return e.deleted
}


func (e *VaultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVaultEntity(e.client, opts)
}

func (e *VaultEntity) Data(args ...any) any {
...
func (e *VaultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Vault; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VaultEntity) DataTyped(data ...Vault) Vault {
	if len(data) > 0 {
		return typedFrom[Vault](e.Data(asMap(data[0])))
	}
	return typedFrom[Vault](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Vault (all fields
// optional at the wire level).
func (e *VaultEntity) MatchTyped(match ...Vault) Vault {
	if len(match) > 0 {
		return typedFrom[Vault](e.Match(asMap(match[0])))
	}
	return typedFrom[Vault](e.Match())
}
...
func (e *VaultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VaultEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VaultLoadMatch and returns an Vault. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VaultEntity) LoadTyped(reqmatch VaultLoadMatch, ctrl map[string]any) (Vault, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Vault{}, err
	}
	return typedFrom[Vault](res), nil
}




func (e *VaultEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// VaultListMatch and returns []Vault. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VaultEntity) ListTyped(reqmatch VaultListMatch, ctrl map[string]any) ([]Vault, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Vault](res), nil
}




func (e *VaultEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// VaultCreateData and returns an Vault. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *VaultEntity) CreateTyped(reqdata VaultCreateData, ctrl map[string]any) (Vault, error) {
...
func (e *VaultEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// VaultUpdateData and returns an Vault. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *VaultEntity) UpdateTyped(reqdata VaultUpdateData, ctrl map[string]any) (Vault, error) {
...
func (e *VaultEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// VaultRemoveMatch and returns an Vault. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *VaultEntity) RemoveTyped(reqmatch VaultRemoveMatch, ctrl map[string]any) (Vault, error) {
...
func (e *VaultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
