...
func NewOpenEntity(client *core.ObsidianSDK, entopts map[string]any) *OpenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OpenEntity) GetName() string { return e.name }
...
func (e *OpenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OpenEntity) Deleted() bool {
	return e.deleted
}


func (e *OpenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOpenEntity(e.client, opts)
}

func (e *OpenEntity) Data(args ...any) any {
...
func (e *OpenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Open; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OpenEntity) DataTyped(data ...Open) Open {
	if len(data) > 0 {
		return typedFrom[Open](e.Data(asMap(data[0])))
	}
	return typedFrom[Open](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Open (all fields
// optional at the wire level).
func (e *OpenEntity) MatchTyped(match ...Open) Open {
	if len(match) > 0 {
		return typedFrom[Open](e.Match(asMap(match[0])))
	}
	return typedFrom[Open](e.Match())
}
...
func (e *OpenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OpenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OpenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OpenEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OpenCreateData and returns an Open. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OpenEntity) CreateTyped(reqdata OpenCreateData, ctrl map[string]any) (Open, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Open{}, err
	}
	return typedFrom[Open](res), nil
}



func (e *OpenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OpenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OpenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
