...
type Args struct {
	Entity string         `json:"entity" jsonschema:"active | command | entity1 | mcp | open | search | system | tag | vault"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ObsidianSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "obsidian_list",
		Description: "List records from Obsidian. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "obsidian_load",
		Description: "Load a single record from Obsidian. " +
...
func runOp(client *sdk.ObsidianSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
